...
public class BinarySearch {
	...
	/**
	 * Her brukes bin�rs�king for � s�ke etter elementet 8 i tabellen �verst i main-metoden
	 * 
	 * Ved bruk av bin�rs�king i sorterte tabeller kan man finne hvilke som helst elementer i tobellen
	 * mer effektivt enn line�rs�king ved � finne midtpunktet, ((min-index)+(max-index))/2, s� fortsette
	 * � eliminere store deler av s�kingsomr�de til man finner elementet.
	 * */
	...
	public static void main(String[] args) {
		...
		//Sjekker at dersom min er st�rre en maks, blir -1 returnert ->
		...
		//Sjekker med hvilken som helst brukerinput(int) for � sjekke hvilke heltall
